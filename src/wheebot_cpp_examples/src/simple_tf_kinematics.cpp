#include "wheebot_cpp_examples/simple_tf_kinematics.hpp"
    ...
    , last_x_(0.0)
{
    ...
    static_transform_stamped_.header.frame_id = "wheebot_base";
    static_transform_stamped_.child_frame_id = "wheebot_top";
...
void SimpleTfKinematics::timerCallback()
{
    ...
    dynamic_transform_stamped_.child_frame_id = "wheebot_base";
