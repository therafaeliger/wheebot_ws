...
#include "wheebot_planning/dijkstra_planner.hpp"

namespace wheebot_planning
{
...
PLUGINLIB_EXPORT_CLASS(wheebot_planning::DijkstraPlanner, nav2_core::GlobalPlanner)